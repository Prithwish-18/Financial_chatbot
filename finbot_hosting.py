...
API_KEY = "AIzaSyAuZCY01D6RshxIWcKlVGvSDp2H-hdRT8w"  # Set this in your hosting platform
...
def main():
    st.title("GenAI-Powered Financial Assistant for Better Investing Decisions")
